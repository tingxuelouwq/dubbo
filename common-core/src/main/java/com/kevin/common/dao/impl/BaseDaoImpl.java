package com.kevin.common.dao.impl;
...
import com.kevin.common.ret.RetStatusCode;
...
public abstract class BaseDaoImpl<T extends BaseEntity> implements BaseDao<T> {
    ...
    public int insert(T entity) {
        ...
        if (result <= 0) {
            throw new BaseException(RetFormat.format(RetStatusCode.DB_INSERT_RESULT_0, getStatement(SQL_INSERT)));
        }
        return result;
    }
    ...
    public int batchInsert(List<T> list) {
        ...
        if (result <= 0) {
            throw new BaseException(RetFormat.format(RetStatusCode.DB_INSERT_RESULT_0, getStatement(SQL_BATCH_INSERT)));
        }
        return result;
    }
    ...
    public int update(T entity) {
        ...
        if (result <= 0) {
            throw new BaseException(RetFormat.format(RetStatusCode.DB_UPDATE_RESULT_0, getStatement(SQL_UPDATE)));
        }
    ...
    public int batchUpdate(List<T> list) {
        ...
        if (result <= 0) {
            throw new BaseException(RetFormat.format(RetStatusCode.DB_UPDATE_RESULT_0, getStatement(SQL_BATCH_UPDATE)));
        }
        return result;
    }
