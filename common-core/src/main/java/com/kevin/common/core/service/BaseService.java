package com.kevin.common.core.service;
...
public interface BaseService<T> {
     ...
     * @描述：根据实体对象保存记录
     */
    int insert(T entity) throws BaseException;
     ...
     * @描述：根据实体对象列表批量保存记录
     */
    int batchInsert(List<T> list) throws BaseException;
     ...
     * @描述：更新实体对象对应的记录
     */
    int update(T entity) throws BaseException;
     ...
     * @描述：批量更新实体对象对应的记录
     */
    int batchUpdate(List<T> list) throws BaseException;
